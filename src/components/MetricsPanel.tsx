...
export interface MetricsPanelProps {
  ...
  horizontalEval?: boolean
  hideOpeningStats?: boolean
}
 ...
 */
export function MetricsPanel({ eval_, lichess, horizontalEval = false, hideOpeningStats = false }: MetricsPanelProps) {
  return (
